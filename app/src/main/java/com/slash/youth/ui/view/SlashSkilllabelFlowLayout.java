 ...
 */
public class SlashSkilllabelFlowLayout extends ViewGroup {

    private int mUsedWidth;// 当前行已使用的宽度
    private int mHorizontalSpacing = CommonUtils.dip2px(6);// 水平间距
    private int mVerticalSpacing = CommonUtils.dip2px(8);// 竖直间距
    ...
    public SlashSkilllabelFlowLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public SlashSkilllabelFlowLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlashSkilllabelFlowLayout(Context context) {
        this(context, null);
    }
