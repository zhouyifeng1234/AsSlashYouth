...
public class PublishDemandActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PublishDemandModel publishDemandModel = new PublishDemandModel(activityPublishDemandBinding);
        activityPublishDemandBinding.setPublishDemandModel(publishDemandModel);

        mMapView = activityPublishDemandBinding.mapviewActivityPublishDemand;
