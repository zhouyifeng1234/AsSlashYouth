package com.slash.youth.ui.view.PullableListView;
        ...
        switch (state) {
            case INIT:
             ...
             /*   loadStateImageView.setVisibility(View.GONE);
                ...
                if (mIPullToRefreshStateChangeListener != null) {
                    mIPullToRefreshStateChangeListener.init();
                }
                break;
            case RELEASE_TO_REFRESH:
               ...
               /* refreshStateTextView.setText(R.string.release_to_refresh);
                ...
                if (mIPullToRefreshStateChangeListener != null) {
                    mIPullToRefreshStateChangeListener.releaseToRefresh();
                }
                break;
            case REFRESHING:
                // 正在刷新状态
               /* pullView.clearAnimation();
                ...
                if (mIPullToRefreshStateChangeListener != null) {
                    mIPullToRefreshStateChangeListener.refreshing();
                }
                break;
            case RELEASE_TO_LOAD:
              ...
              /*  loadStateTextView.setText(R.string.release_to_load);
                ...
                if (mIPullToRefreshStateChangeListener != null) {
                    mIPullToRefreshStateChangeListener.releaseToLoad();
                }
                break;
            case LOADING:
                // 正在加载状态
               /* pullUpView.clearAnimation();
                ...
                if (mIPullToRefreshStateChangeListener != null) {
                    mIPullToRefreshStateChangeListener.loading();
                }
                break;
            case DONE:
                // 刷新或加载完毕
                if (mIPullToRefreshStateChangeListener != null) {
                    mIPullToRefreshStateChangeListener.done();
                }
                break;
        }
    }

    private IPullToRefreshStateChangeListener mIPullToRefreshStateChangeListener;

    public interface IPullToRefreshStateChangeListener {
        public void init();//下拉布局初始状态回调方法

        public void releaseToRefresh();//释放刷新状态回调

        public void refreshing();//正在刷新状态回到

        public void releaseToLoad();//释放加载状态回调

        public void loading();//正在加载状态回调

        public void done();//刷新或加载完毕回调
    }

    public void setPullToRefreshStateChangeListener(IPullToRefreshStateChangeListener iPullToRefreshStateChangeListener) {
        this.mIPullToRefreshStateChangeListener = iPullToRefreshStateChangeListener;
    }
