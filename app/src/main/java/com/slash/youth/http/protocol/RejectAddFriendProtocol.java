 ...
 */
public class RejectAddFriendProtocol extends BaseProtocol<CommonResultBean> {

    private String uid;
    private String extra;

    public RejectAddFriendProtocol(String uid, String extra) {
        this.uid = uid;
        this.extra = extra;
    }
    ...
    public String getUrlString() {
        return GlobalConstants.HttpUrl.REJECT_ADD_FRIEND;
    }
