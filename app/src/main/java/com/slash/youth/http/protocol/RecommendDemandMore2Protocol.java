 ...
 */
public class RecommendDemandMore2Protocol extends BaseProtocol<HomeRecommendList2> {
    ...
    public RecommendDemandMore2Protocol(String rec_offset, String rec_limit, String rad_offset, String rad_limit) {
    ...
    public String getUrlString() {
        return GlobalConstants.HttpUrl.GET_RECOMMEND_DEMAND_MORE2;
    }
