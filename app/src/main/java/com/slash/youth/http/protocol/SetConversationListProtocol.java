 ...
 */
public class SetConversationListProtocol extends BaseProtocol<CommonResultBean> {

    private ArrayList<Long> conversationUidList;

    public SetConversationListProtocol(ArrayList<Long> conversationUidList) {
        this.conversationUidList = conversationUidList;
    }

    @Override
    public String getUrlString() {
        return GlobalConstants.HttpUrl.SET_CONVERSATION_LIST;
    }
