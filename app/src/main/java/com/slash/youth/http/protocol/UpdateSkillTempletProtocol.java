...
public class UpdateSkillTempletProtocol extends BaseProtocol<SetBean> {
    ...
    public UpdateSkillTempletProtocol(long id,String title, ArrayList<String> listTag, long startime, long endtime, int anonymity, String desc,  ArrayList<String> listPic, int instalment, int bp, int pattern, String place, double lng, double lat, double quote, int quoteunit) {
        this.id = id;
        this.title = title;
