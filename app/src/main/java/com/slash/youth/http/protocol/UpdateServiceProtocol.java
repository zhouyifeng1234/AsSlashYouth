...
/**
 * Created by zhouyifeng on 2016/12/2.
 */
public class UpdateServiceProtocol extends BaseProtocol<CommonResultBean> {
    ...
    public UpdateServiceProtocol(String id, String title, ArrayList<String> listTag, long startime, long endtime, int anonymity, String desc, int timetype, ArrayList<String> listPic, int instalment, int bp, int pattern, String place, double lng, double lat, double quote, int quoteunit) {
        this.id = id;
        this.title = title;
    ...
    public String getUrlString() {
        return GlobalConstants.HttpUrl.UPDATE_SERVICE;
    }
